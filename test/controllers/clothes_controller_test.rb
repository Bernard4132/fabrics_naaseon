...
class ClothesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clothe" do
    assert_difference('Clothe.count') do
      post clothes_url, params: { clothe: { category: @clothe.category, description: @clothe.description, name: @clothe.name } }
    end
  ...
  test "should update clothe" do
    patch clothe_url(@clothe), params: { clothe: { category: @clothe.category, description: @clothe.description, name: @clothe.name } }
