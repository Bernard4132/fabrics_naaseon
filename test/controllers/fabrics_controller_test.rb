...
class FabricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fabric" do
    assert_difference('Fabric.count') do
      post fabrics_url, params: { fabric: { description: @fabric.description, fabricimage: @fabric.fabricimage, price: @fabric.price, title: @fabric.title } }
    end
  ...
  test "should update fabric" do
    patch fabric_url(@fabric), params: { fabric: { description: @fabric.description, fabricimage: @fabric.fabricimage, price: @fabric.price, title: @fabric.title } }
